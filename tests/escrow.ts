...
describe("escrow", () => {
  ...
  const program = anchor.workspace.AnchorEscrowQ22025 as Program<Escrow>;
  ...
  it("Airdrop and create mints", async () => {
    let lamports = await getMinimumBalanceForRentExemptMint(connection as any);
    ...
    await provider.sendAndConfirm(tx as any, [mintA, mintB, maker, taker]).then(log);
  });
